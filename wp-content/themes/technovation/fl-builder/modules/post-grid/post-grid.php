				...
				'fields'        => array(
					'layout'        => array(
						...
						'options'       => array(
							...
							'news'					=> __('In the News', 'technovation')
						),
						'toggle'        => array(
							'grid'          => array(
								'sections'      => array('grid', 'image', 'content'),
								'fields'        => array('show_author', 'match_height', 'pagination', 'posts_per_page')
							),
							'feed'          => array(
								'sections'      => array('image', 'content'),
								'fields'        => array('image_position', 'show_author', 'show_comments', 'content_type', 'pagination', 'posts_per_page')
							),
							'gallery'		=> array(
								'tabs'			=> array( 'style' ),
								'sections'	=> array( 'icons', 'text_style' ),
								'fields'		=> array('pagination', 'posts_per_page', 'hover_transition')
							),
							'news'			=> array(
								'tabs'				=> array('style'),
								'fields'			=> array('show_author', 'show_date', 'color_scheme')
							)
						)
					),
					'match_height'  => array(
		...
		'sections'      => array( // Tab Sections
			'gallery_general'          => array(
				...
				'fields'        => array(
					...
					'color_scheme'		=> array(
						'type'						=> 'select',
						'label'						=> __('Color Scheme', 'technovation'),
						'default'					=> 'blue',
						'options'					=> array(
